...
use Homeful\Notifications\Mails\ReuploadDocumentBuyerMail;
use Homeful\Notifications\Mails\BaseMail;

class ReuploadDocumentBuyerNotification extends BaseNotification
{
    public function getSMSContent(object $notifiable): string
    {
        return trans(
            key: 'notifications::messages.reupload_document_buyer.sms',
            replace: [
    ...
    {
        return new ReuploadDocumentBuyerMail($this->getReferenceData(), $notifiable);
    }
}
