...
use Homeful\Notifications\Mails\ValidatedToCancelledBuyerMail;

class ValidatedToCancelledBuyerNotification extends BaseNotification
{
    public function getSMSContent(object $notifiable): string
    {
        return trans(
            key: 'notifications::messages.validated_to_cancelled_buyer.sms',
            replace: [
    ...
    {
        return new ValidatedToCancelledBuyerMail($this->getReferenceData(), $notifiable);
    }
}
