...
use Homeful\Notifications\Mails\PrequalifiedToQualifiedBuyerMail;

class PrequalifiedToQualifiedBuyerNotification extends BaseNotification
{
    public function getSMSContent(object $notifiable): string
    {
        return trans(
            key: 'notifications::messages.prequalified_to_qualified_buyer.sms',
            replace: [
    ...
    {
        return new PrequalifiedToQualifiedBuyerMail($this->getReferenceData(), $notifiable);
    }
}
