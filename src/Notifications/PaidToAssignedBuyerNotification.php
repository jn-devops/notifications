...
use Homeful\Notifications\Mails\PaidToAssignedBuyerMail;
use Homeful\Notifications\Mails\BaseMail;

class PaidToAssignedBuyerNotification extends BaseNotification
{
    public function getSMSContent(object $notifiable): string
    {
        return trans(
            key: 'notifications::messages.paid_to_assigned_buyer.sms',
            replace: [
    ...
    {
        return new PaidToAssignedBuyerMail($this->getReferenceData(), $notifiable);
    }
}
