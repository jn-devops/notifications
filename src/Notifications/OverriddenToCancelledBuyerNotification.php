...
use Homeful\Notifications\Mails\OverriddenToCancelledBuyerMail;

class OverriddenToCancelledBuyerNotification extends BaseNotification
{
    public function getSMSContent(object $notifiable): string
    {
        return trans(
            key: 'notifications::messages.overridden_to_cancelled_buyer.sms',
            replace: [
    ...
    {
        return new OverriddenToCancelledBuyerMail($this->getReferenceData(), $notifiable);
    }
}
