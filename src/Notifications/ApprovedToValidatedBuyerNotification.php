...
use Homeful\Notifications\Mails\ApprovedToValidatedBuyerMail;
use Homeful\Notifications\Mails\BaseMail;

class ApprovedToValidatedBuyerNotification extends BaseNotification
{
    public function getSMSContent(object $notifiable): string
    {
        return trans(
            key: 'notifications::messages.approved_to_validated_buyer.sms',
            replace: [
    ...
    {
        return new ApprovedToValidatedBuyerMail($this->getReferenceData(), $notifiable);
    }
}
