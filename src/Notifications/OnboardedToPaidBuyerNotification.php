...
use Homeful\Notifications\Mails\OnboardedToPaidBuyerMail;
use Homeful\Notifications\Mails\BaseMail;

class OnboardedToPaidBuyerNotification extends BaseNotification
{
    public function getSMSContent(object $notifiable): string
    {
        return trans(
            key: 'notifications::messages.onboarded_to_paid_buyer.sms',
            replace: [
    ...
    {
        return new OnboardedToPaidBuyerMail($this->getReferenceData(), $notifiable);
    }
}
